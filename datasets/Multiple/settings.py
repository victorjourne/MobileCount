...
from datasets.Multiple.loader import CustomGCC, CustomSHH, CustomCCLabeler, CustomWE, CustomJHU
...
__C_DYN.TRAIN_SIZE = (576, 768)  # For SHHB
...
__C_DYN.MEAN_STD = (
[0.504379212856, 0.510956227779, 0.505369007587], [0.22513884306, 0.225588873029, 0.22579960525])  # JHU
...
__C_DYN.PATH_SETTINGS = {
    ...
    'JHU__gt_path': '/workspace/home/jourdanfa/data/density_maps/jhu_crowd_v2.0'  # TODO
}
